...
Q: Would you consider changing the license to 
Q: Are you accepting pull requests?

A: Yes!  We don't have formal guidelines for pull requests, but if you have a change you think should be included or a bug you wanted to fix, submit the PR and we'll review.
